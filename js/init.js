...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'max': { range: '*', href: themepath +  'css/style.css', containers: 1440, viewport: { scalable: false }, grid: { gutters: 40 } },
			'wide': { range: '-1920', href: themepath +  'css/style-wide.css', containers: 1360 },
			'normal': { range: '-1680', href: themepath +  'css/style-normal.css', containers: 1200 },
			'narrow': { range: '-1280', href: themepath +  'css/style-narrow.css', containers: 960 },
			'narrower': { range: '-1000', href: themepath +  'css/style-narrower.css', containers: '95%' },
			'mobile': { range: '-736', href: themepath +  'css/style-mobile.css', grid: { gutters: 20 } },
